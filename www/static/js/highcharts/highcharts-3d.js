...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/highcharts-3d", ["highcharts"], function (B) {
        a(B);
        a.Highcharts = B;
        return a
    ...
    B(a, "Extensions/Math3D.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, l) {
        var u = l.pick, d = a.deg2rad, m = a.perspective3D = function (d,
            ...
            var b = a.options.chart.options3d, p = u(r, h ? a.inverted : !1),
                n = {x: a.plotWidth / 2, y: a.plotHeight / 2, z: b.depth / 2, vd: u(b.depth, 1) * u(b.viewDistance, 0)},
                q = a.scale3d || 1;
            r = d * b.beta * (p ? -1 : 1);
            b = d * b.alpha * (p ? -1 : 1);
            var c = Math.cos(b), A = Math.cos(-r), v = Math.sin(b), e = Math.sin(-r);
        ...
        l = a.pointCameraDistance = function (d, k) {
            var h = k.options.chart.options3d, a = k.plotWidth / 2;
            k = k.plotHeight / 2;
            h = u(h.depth, 1) * u(h.viewDistance, 0) + h.depth;
            return Math.sqrt(Math.pow(a - u(d.plotX, d.x), 2) + Math.pow(k - u(d.plotY, d.y), 2) + Math.pow(h - u(d.plotZ, d.z), 2))
        };
        ...
        return {perspective: w, perspective3D: m, pointCameraDistance: l, shapeArea: k, shapeArea3D: a}
    });
    B(a, "Core/Renderer/SVG/SVGRenderer3D.js", [a["Core/Color.js"], a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function (a, l, u, d, m, w) {
        function k(c, e, f, d, b, x, D, E) {
            var g = [], t = x - b;
            return x > b && x - b > Math.PI / 2 + .0001 ? (g = g.concat(k(c, e, f, d, b, b + Math.PI / 2, D, E)), g = g.concat(k(c,
        ...
        var G = a.parse, p = u.perspective, h = u.shapeArea, r = w.animObject, b = w.defined, L = w.extend, n = w.merge,
            q = w.objectEach, c = w.pick, A = Math.cos, v = Math.PI, e = Math.sin, C = l.charts, M = l.deg2rad;
        var F =
            4 * (Math.sqrt(2) - 1) / 3 / (v / 2);
        ...
        m.prototype.face3d = function (g) {
            var e = this, f = this.createElement("path");
            f.vertexes = [];
            f.insidePlotArea = !1;
            f.enabled = !0;
            f.attr = function (f) {
                if ("object" === typeof f && (b(f.enabled) || b(f.vertexes) || b(f.insidePlotArea))) {
                    ...
                    var g = p(this.vertexes, C[e.chartIndex], this.insidePlotArea), x = e.toLinePath(g, !0);
                    g = h(g);
        ...
        m.prototype.polyhedron = function (c) {
            var g = this, f = this.g(), e = f.destroy;
            ...
            f.attr = function (c, e, D, E) {
                if ("object" === typeof c && b(c.faces)) {
                    ...
                    for (var x = 0; x < c.faces.length; x++) g.styledMode && delete c.faces[x].fill, f.faces[x].attr(c.faces[x], null, D, E);
                    delete c.faces
                }
                return d.prototype.attr.apply(this, arguments)
            };
            f.animate = function (c, e, b) {
                if (c && c.faces) {
                    for (; f.faces.length >
                           c.faces.length;) f.faces.pop().destroy();
                    for (; f.faces.length < c.faces.length;) f.faces.push(g.face3d().add(f));
                    for (var x = 0; x < c.faces.length; x++) f.faces[x].animate(c.faces[x], e, b);
                    delete c.faces
                }
                return d.prototype.animate.apply(this, arguments)
            };
        ...
        a = {
            initArgs: function (c) {
                var g = this, f = g.renderer, e = f[g.pathType + "Path"](c), d = e.zIndexes;
                g.parts.forEach(function (c) {
                    g[c] = f.path(e[c]).attr({"class": "highcharts-3d-" + c, zIndex: d[c] || 0}).add(g)
                });
                ...
                var E = f && f.zIndexes;
                f ? (E && E.group && this.attr({zIndex: E.group}), q(f, function (e, t) {
                    g[t] = {};
                    g[t][c] = e;
        ...
        var N = n(a, {
            parts: ["front", "top", "side"], pathType: "cuboid", attr: function (c, e, f, h) {
                if ("string" === typeof c && "undefined" !== typeof e) {
                    var g = c;
                    c = {};
                    c[g] = e
                }
                return c.shapeArgs || b(c.x) ? this.singleSetterForParts("d", null, this.renderer[this.pathType + "Path"](c.shapeArgs || c)) : d.prototype.attr.call(this, c, void 0, f, h)
            }, animate: function (c, e, f) {
                if (b(c.x) && b(c.y)) {
                    c = this.renderer[this.pathType + "Path"](c);
                    var g = c.forcedSides;
                    this.singleSetterForParts("d", null, c, "animate",
                        e, f);
                ...
                this.singleSetterForParts("fill", null, {
                    front: c,
                    top: G(c).brighten(0 <= this.forcedSides.indexOf("top") ? 0 : .1).get(),
                    side: G(c).brighten(0 <= this.forcedSides.indexOf("side") ? 0 : -.1).get()
                });
        ...
        m.prototype.cuboidPath = function (c) {
            function e(c) {
                return 0 === D && 1 < c && 6 > c ? {
                    ...
                    y: a[c].y,
                    z: a[c].z
                } : 0 === v && 2 > c || 5 < c ? {x: a[c].x, y: a[c].y, z: a[c].z + 10} : a[c]
            }
            ...
            var g = c.x, d = c.y, b = c.z || 0, D = c.height, E = c.width, v = c.depth, t = C[this.chartIndex],
                y = t.options.chart.options3d.alpha, A = 0, a = [{
                    x: g,
                    y: d, z: b
                }, {x: g + E, y: d, z: b}, {x: g + E, y: d + D, z: b}, {x: g, y: d + D, z: b}, {
                    x: g,
                    y: d + D,
                    z: b + v
                }, {x: g + E, y: d + D, z: b + v}, {x: g + E, y: d, z: b + v}, {x: g, y: d, z: b + v}], q = [];
            a = p(a, t, c.insidePlotArea);
            var z = function (c, t, g) {
                var d = [[], -1], b = c.map(f), y = t.map(f);
                c = c.map(e);
                t = t.map(e);
                0 > h(b) ? d = [b, 0] : 0 > h(y) ? d = [y, 1] : g && (q.push(g), d = 0 > h(c) ? [b, 0] : 0 > h(t) ? [y, 1] : [b, 0]);
                return d
            };
            ...
            z = k[0];
            k = k[1];
            1 === k ? A += 1E6 * (t.plotWidth -
                g) : k || (A += 1E6 * g);
            A += 10 * (!r || 0 <= y && 180 >= y || 360 > y && 357.5 < y ? t.plotHeight - d : 10 + d);
        ...
        m.prototype.arc3d = function (e) {
            function b(c) {
                var f = !1, e = {}, d;
                c = n(c);
                for (d in c) -1 !== a.indexOf(d) && (e[d] = c[d], delete c[d], f = !0);
                return f ? [e, c] : !1
            }

            var f = this.g(), g = f.renderer, a = "x y r innerR start end depth".split(" ");
            e = n(e);
            e.alpha = (e.alpha ||
                0) * M;
            e.beta = (e.beta || 0) * M;
            ...
            f.out = g.path();
            f.onAdd = function () {
                var c = f.parentGroup, e = f.attr("class");
                f.top.add(f);
            ...
            f.animate = function (e, g, a) {
                var v = this.attribs, t = "data-" + Math.random().toString(26).substring(2, 9);
                delete e.center;
                delete e.z;
                delete e.alpha;
                delete e.beta;
        ...
        m.prototype.arc3dPath = function (c) {
            ...
            var f = c.x, b = c.y, g = c.start, a = c.end - .00001, h = c.r, q = c.innerR || 0, n = c.depth || 0,
                t = c.alpha, y = c.beta, J = Math.cos(g), K = Math.sin(g);
            c = Math.cos(a);
            var I = Math.sin(a),
                z = h * Math.cos(y);
            h *= Math.cos(t);
            var H = q * Math.cos(y), C = q * Math.cos(t);
            q = n * Math.sin(y);
            var r = n * Math.sin(t);
            n = [["M", f + z * J, b + h * K]];
            ...
            y = 0 < t ? 0 : Math.PI / 2;
            m = g > -m ? g : a > -m ? -m : g;
            var p = a < v - y ? a : g < v - y ? v - y : a, F = 2 * v - y;
            t = [["M", f + z * A(m), b + h * e(m)]];
            t = t.concat(k(f, b, z, h, m, p, 0, 0));
            a > F && g < F ? (t.push(["L", f + z * A(p) + q, b + h * e(p) + r]), t = t.concat(k(f, b, z, h, p, F, q, r)), t.push(["L", f + z * A(F), b + h * e(F)]), t = t.concat(k(f,
                b, z, h, F, a, 0, 0)), t.push(["L", f + z * A(a) + q, b + h * e(a) + r]), t = t.concat(k(f, b, z, h, a, F, q, r)), t.push(["L", f + z * A(F), b + h * e(F)]), t = t.concat(k(f, b, z, h, F, p, 0, 0))) : a > v - y && g < v - y && (t.push(["L", f + z * Math.cos(p) + q, b + h * Math.sin(p) + r]), t = t.concat(k(f, b, z, h, p, a, q, r)), t.push(["L", f + z * Math.cos(a), b + h * Math.sin(a)]), t = t.concat(k(f, b, z, h, a, p, 0, 0)));
            t.push(["L", f + z * Math.cos(p) + q, b + h * Math.sin(p) + r]);
            t = t.concat(k(f, b, z, h, p, m, q, r));
            t.push(["Z"]);
            y = [["M", f + H * J, b + C * K]];
            y = y.concat(k(f, b, H, C, g, a, 0, 0));
            y.push(["L", f + H * Math.cos(a) + q, b +
            C * Math.sin(a) + r]);
            y = y.concat(k(f, b, H, C, a, g, q, r));
            y.push(["Z"]);
            J = [["M", f + z * J, b + h * K], ["L", f + z * J + q, b + h * K + r], ["L", f + H * J + q, b + C * K + r], ["L", f + H * J, b + C * K], ["Z"]];
            f = [["M", f + z * c, b + h * I], ["L", f + z * c + q, b + h * I + r], ["L", f + H * c + q, b + C * I + r], ["L", f + H * c, b + C * I], ["Z"]];
            I = Math.atan2(r, -q);
            b = Math.abs(a + I);
            c = Math.abs(g + I);
            g = Math.abs((g + a) / 2 + I);
    ...
    B(a, "Core/Axis/Tick3D.js",
        [a["Core/Utilities.js"]], function (a) {
            var l = a.addEvent, u = a.extend, d = a.wrap;
            return function () {
                function a() {
                }
                ...
                a.wrapGetMarkPath = function (d) {
                    var a = this.axis.axis3D, m = d.apply(this, [].slice.call(arguments, 1));
                    if (a) {
                        var p = m[0], h = m[1];
                        if ("M" === p[0] && "L" === h[0]) return a = [a.fix3dPosition({
                            x: p[1],
                            y: p[2], z: 0
    ...
    B(a, "Core/Axis/Axis3D.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Axis/Tick.js"], a["Core/Axis/Tick3D.js"], a["Core/Utilities.js"]], function (a, l, u, d, m) {
        var w = l.perspective, k = l.perspective3D, G = l.shapeArea, p = m.addEvent, h = m.merge, r = m.pick,
            b = m.wrap, L = a.deg2rad, n = function () {
                function b(c) {
                    this.axis = c
                }
                ...
                b.prototype.fix3dPosition = function (c, b) {
                    ...
                    if ("colorAxis" ===
                        d.coll || !e.chart3d || !e.is3d()) return c;
                    var a = L * e.options.chart.options3d.alpha, h = L * e.options.chart.options3d.beta,
                        q = r(b && d.options.title.position3d, d.options.labels.position3d);
                    b = r(b && d.options.title.skew3d, d.options.labels.skew3d);
                    var k = e.chart3d.frame3d, g = e.plotLeft, A = e.plotWidth + g, f = e.plotTop, n = e.plotHeight + f;
                    e = !1;
                    var p = 0, m = 0, l = {x: 0, y: 1, z: 0};
                    ...
                    "chart" !== q && ("flap" === q ? d.horiz ? (h = Math.sin(a), a = Math.cos(a), d.opposite && (h = -h), e && (h = -h), l = {
                        x: g.z * h,
                        y: a,
                        z: -g.x * h
                    }) : g = {
                        ...
                        y: 0,
                        z: Math.sin(h)
                    } : "ortho" === q ? d.horiz ? (l = Math.cos(a), q = Math.sin(h) * l, a = -Math.sin(a), h = -l * Math.cos(h), l = {
                        x: g.y * h - g.z * a,
                        y: g.z * q - g.x * h,
                        z: g.x * a - g.y * q
                    }, a = 1 / Math.sqrt(l.x *
                        l.x + l.y * l.y + l.z * l.z), e && (a = -a), l = {
                        x: a * l.x,
                        y: a * l.y,
                        z: a * l.z
                    }) : g = {x: Math.cos(h), y: 0, z: Math.sin(h)} : d.horiz ? l = {
                    ...
                    c.z += p * g.z + m * l.z;
                    e = w([c], d.chart)[0];
                    b && (0 > G(w([c, {x: c.x + g.x, y: c.y + g.y, z: c.z + g.z}, {
                        x: c.x + l.x,
                        y: c.y + l.y,
                        z: c.z + l.z
                    }], d.chart)) && (g = {x: -g.x, y: -g.y, z: -g.z}), c = w([{x: c.x, y: c.y, z: c.z}, {
                        x: c.x + g.x,
                        y: c.y + g.y,
                        z: c.z + g.z
                    }, {x: c.x + l.x, y: c.y + l.y, z: c.z + l.z}], d.chart), e.matrix =
                        [c[1].x - c[0].x, c[1].y - c[0].y, c[2].x - c[0].x, c[2].y - c[0].y, e.x, e.y], e.matrix[4] -= e.x * e.matrix[0] + e.y * e.matrix[2], e.matrix[5] -= e.x * e.matrix[1] + e.y * e.matrix[3]);
                    return e
                };
        ...
        return function () {
            ...
            a.onAfterSetOptions = function () {
                ...
                c.is3d && c.is3d() && "colorAxis" !== this.coll && (d.tickWidth = r(d.tickWidth, 0), d.gridLineWidth = r(d.gridLineWidth, 1))
            };
            a.onDestroy = function () {
                ["backFrame", "bottomFrame",
                    "sideFrame"].forEach(function (c) {
                    this[c] && (this[c] = this[c].destroy())
                }, this)
            };
            a.onDrawCrosshair = function (c) {
                this.chart.is3d() && "colorAxis" !== this.coll && c.point && (c.point.crosshairPos = this.isXAxis ? c.point.axisXpos : this.len - c.point.axisYpos)
            };
            a.onInit = function () {
            ...
            a.wrapGetPlotBandPath = function (c) {
                ...
                var d = arguments, a = d[2], e = [];
                d = this.getPlotLinePath({value: d[1]});
                a = this.getPlotLinePath({value: a});
                if (d && a) for (var b = 0; b < d.length; b += 2) {
                    var h = d[b], k = d[b + 1], n = a[b], g = a[b + 1];
                    "M" === h[0] && "L" === k[0] && "M" === n[0] && "L" === g[0] && e.push(h, k, g, ["L", n[1], n[2]], ["Z"])
                }
                return e
            };
            a.wrapGetPlotLinePath = function (c) {
                var d = this.axis3D, a = this.chart, e = c.apply(this, [].slice.call(arguments, 1));
                ...
                var k = e[0], n = e[1];
                e = [];
                "M" === k[0] && "L" === n[0] && (d = [d.swapZ({x: k[1], y: k[2], z: 0}), d.swapZ({
                    x: k[1],
                    y: k[2],
                    z: h
                }), d.swapZ({x: n[1], y: n[2], z: 0}), d.swapZ({
                    x: n[1],
                    y: n[2],
                    z: h
                })], this.horiz ? (this.isZAxis ? (b.left.visible && e.push(d[0], d[2]), b.right.visible && e.push(d[1], d[3])) : (b.front.visible && e.push(d[0], d[2]), b.back.visible && e.push(d[1], d[3])), b.top.visible && e.push(d[0], d[1]), b.bottom.visible && e.push(d[2], d[3])) : (b.front.visible && e.push(d[0], d[2]), b.back.visible &&
                e.push(d[1], d[3]), b.left.visible && e.push(d[0], d[1]), b.right.visible && e.push(d[2], d[3])), e = w(e, this.chart, !1));
                return a.renderer.toLineSegments(e)
            };
            a.wrapGetSlotWidth = function (c, d) {
                var b = this.chart, a = this.ticks, h = this.gridGroup;
                if (this.categories && b.frameShapes && b.is3d() && h && d && d.label) {
                    h = h.element.childNodes[0].getBBox();
                    var n = b.frameShapes.left.getBBox(), q = b.options.chart.options3d;
                    b = {
                        x: b.plotWidth / 2,
                        y: b.plotHeight / 2,
                        z: q.depth / 2,
    ...
    B(a, "Core/Axis/ZAxis.js", [a["Core/Axis/Axis.js"], a["Core/Utilities.js"]], function (a, l) {
        var u = this && this.__extends || function () {
                var d = function (a, b) {
                    d = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (d, b) {
                        d.__proto__ = b
                    } || function (d, b) {
            ...
            }(), d = l.addEvent, m = l.merge, w = l.pick,
            k = l.splat, G = function () {
                function a() {
                }
                ...
                a.onAfterGetAxes = function () {
                    ...
                    a = a.zAxis = k(a.zAxis || {});
                    d.is3d() && (d.zAxis = [], a.forEach(function (a, b) {
                        a.index = b;
                        a.isX = !0;
                ...
                a.prototype.getSeriesExtremes = function () {
                    ...
                    d.series.forEach(function (b) {
                        !b.visible && a.options.chart && a.options.chart.ignoreHiddenSeries || (d.hasVisibleSeries = !0, b = b.zData, b.length && (d.dataMin = Math.min(w(d.dataMin, b[0]), Math.min.apply(null, b)), d.dataMax = Math.max(w(d.dataMax, b[0]), Math.max.apply(null, b))))
                    })
                };
                a.prototype.setAxisSize =
                    function () {
                        var a = this.chart;
    ...
    B(a, "Core/Chart/Chart3D.js", [a["Core/Axis/Axis.js"], a["Core/Axis/Axis3D.js"], a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Extensions/Math3D.js"],
        ...
        var p = m.perspective, h = m.shapeArea3D, r = w.defaultOptions, b = k.addEvent;
        m = k.Fx;
        var B = k.isArray, n = k.merge, q = k.pick, c = k.wrap, A;
        (function (a) {
            function e(c) {
            ...
            function k() {
                if (this.chart3d && this.is3d()) {
                    var c = this.renderer, a = this.options.chart.options3d, b = this.chart3d.get3dFrame(),
                        e = this.plotLeft, f = this.plotLeft + this.plotWidth, g = this.plotTop, h = this.plotTop +
                        this.plotHeight;
                    a = a.depth;
                    var k = e - (b.left.visible ? b.left.size : 0), q = f + (b.right.visible ? b.right.size : 0),
                        n = g - (b.top.visible ? b.top.size : 0), m = h + (b.bottom.visible ? b.bottom.size : 0),
                        p = 0 - (b.front.visible ? b.front.size : 0), l = a + (b.back.visible ? b.back.size : 0),
                    ...
                    this.frameShapes.bottom[v]({
                        ...
                        faces: [{
                            ...
                            vertexes: [{x: k, y: m, z: p}, {x: q, y: m, z: p}, {x: q, y: m, z: l}, {x: k, y: m, z: l}],
                            enabled: b.bottom.visible
                        }, {
                            fill: d.color(b.bottom.color).brighten(.1).get(),
                            vertexes: [{x: e, y: h, z: a}, {x: f, y: h, z: a}, {x: f, y: h, z: 0}, {x: e, y: h, z: 0}],
                            enabled: b.bottom.visible
                        }, {
                            fill: d.color(b.bottom.color).brighten(-.1).get(),
                            ...
                            fill: d.color(b.bottom.color).brighten(-.1).get(),
                            vertexes: [{x: q, y: m, z: l}, {x: q, y: m, z: p}, {x: f, y: h, z: 0}, {x: f, y: h, z: a}],
                            enabled: b.bottom.visible && !b.right.visible
                        }, {
                            fill: d.color(b.bottom.color).get(),
                            vertexes: [{x: q, y: m, z: p}, {x: k, y: m, z: p}, {x: e, y: h, z: 0}, {x: f, y: h, z: 0}],
                    ...
                    this.frameShapes.top[v]({
                        ...
                        faces: [{
                            fill: d.color(b.top.color).brighten(.1).get(),
                            vertexes: [{x: k, y: n, z: l}, {x: q, y: n, z: l}, {x: q, y: n, z: p}, {x: k, y: n, z: p}],
                            enabled: b.top.visible
                        }, {
                            fill: d.color(b.top.color).brighten(.1).get(),
                            vertexes: [{x: e, y: g, z: 0}, {x: f, y: g, z: 0}, {x: f, y: g, z: a}, {x: e, y: g, z: a}],
                            enabled: b.top.visible
                        }, {
                            fill: d.color(b.top.color).brighten(-.1).get(),
                            ...
                            fill: d.color(b.top.color).brighten(-.1).get(),
                            vertexes: [{x: q, y: n, z: p}, {x: q, y: n, z: l}, {x: f, y: g, z: a}, {x: f, y: g, z: 0}],
                            enabled: b.top.visible && !b.right.visible
                        }, {
                            fill: d.color(b.top.color).get(),
                            vertexes: [{x: k, y: n, z: p}, {x: q, y: n, z: p}, {x: f, y: g, z: 0}, {x: e, y: g, z: 0}],
                            enabled: b.top.visible && !b.front.visible
                        }, {
                            fill: d.color(b.top.color).get(),
                            vertexes: [{x: q, y: n, z: l}, {x: k, y: n, z: l}, {x: e, y: g, z: a}, {x: f, y: g, z: a}],
                    ...
                    this.frameShapes.left[v]({
                        ...
                        faces: [{
                            ...
                            vertexes: [{x: k, y: m, z: p}, {x: e, y: h, z: 0}, {x: e, y: h, z: a}, {x: k, y: m, z: l}],
                            enabled: b.left.visible && !b.bottom.visible
                        }, {
                            fill: d.color(b.left.color).brighten(.1).get(),
                            vertexes: [{x: k, y: n, z: l}, {x: e, y: g, z: a}, {x: e, y: g, z: 0}, {x: k, y: n, z: p}],
                            ...
                            fill: d.color(b.left.color).brighten(-.1).get(),
                            vertexes: [{x: e, y: g, z: a}, {x: e, y: h, z: a}, {x: e, y: h, z: 0}, {x: e, y: g, z: 0}],
                            enabled: b.left.visible
                        }, {
                            fill: d.color(b.left.color).get(),
                            vertexes: [{x: k, y: m, z: p}, {x: k, y: n, z: p}, {x: e, y: g, z: 0}, {x: e, y: h, z: 0}],
                            enabled: b.left.visible && !b.front.visible
                        }, {
                            fill: d.color(b.left.color).get(),
                            vertexes: [{x: k, y: n, z: l}, {x: k, y: m, z: l}, {x: e, y: h, z: a}, {x: e, y: g, z: a}],
                    ...
                    this.frameShapes.right[v]({
                        ...
                        faces: [{
                            ...
                            vertexes: [{x: q, y: m, z: l}, {x: f, y: h, z: a}, {x: f, y: h, z: 0}, {x: q, y: m, z: p}],
                            enabled: b.right.visible && !b.bottom.visible
                        }, {
                            fill: d.color(b.right.color).brighten(.1).get(),
                            vertexes: [{x: q, y: n, z: p}, {x: f, y: g, z: 0}, {x: f, y: g, z: a}, {x: q, y: n, z: l}],
                            enabled: b.right.visible && !b.top.visible
                        }, {
                            fill: d.color(b.right.color).brighten(-.1).get(),
                            vertexes: [{x: f, y: g, z: 0}, {x: f, y: h, z: 0}, {x: f, y: h, z: a}, {x: f, y: g, z: a}],
                            ...
                            vertexes: [{x: q, y: n, z: p}, {x: q, y: m, z: p}, {x: f, y: h, z: 0}, {x: f, y: g, z: 0}],
                            enabled: b.right.visible && !b.front.visible
                        }, {
                            fill: d.color(b.right.color).get(),
                            vertexes: [{x: q, y: m, z: l}, {x: q, y: n, z: l}, {x: f, y: g, z: a}, {x: f, y: h, z: a}],
                    ...
                    this.frameShapes.back[v]({
                        ...
                        faces: [{
                            ...
                            fill: d.color(b.back.color).brighten(.1).get(),
                            vertexes: [{x: k, y: n, z: l}, {x: q, y: n, z: l}, {x: f, y: g, z: a}, {x: e, y: g, z: a}],
                            enabled: b.back.visible && !b.top.visible
                        }, {
                            fill: d.color(b.back.color).brighten(-.1).get(),
                            vertexes: [{x: k, y: m, z: l}, {x: k, y: n, z: l}, {x: e, y: g, z: a}, {x: e, y: h, z: a}],
                            ...
                            vertexes: [{x: e, y: g, z: a}, {x: f, y: g, z: a}, {x: f, y: h, z: a}, {x: e, y: h, z: a}],
                            enabled: b.back.visible
                        }, {
                            fill: d.color(b.back.color).get(),
                            vertexes: [{x: k, y: m, z: l}, {x: q, y: m, z: l}, {x: q, y: n, z: l}, {x: k, y: n, z: l}],
                            enabled: b.back.visible
                        }]
                    });
                    this.frameShapes.front[v]({
                        ...
                        faces: [{
                            ...
                            fill: d.color(b.front.color).brighten(.1).get(),
                            vertexes: [{x: q, y: n, z: p}, {x: k, y: n, z: p}, {x: e, y: g, z: 0}, {x: f, y: g, z: 0}],
                            enabled: b.front.visible && !b.top.visible
                        }, {
                            fill: d.color(b.front.color).brighten(-.1).get(),
                            vertexes: [{x: k, y: n, z: p}, {x: k, y: m, z: p}, {x: e, y: h, z: 0}, {x: e, y: g, z: 0}],
                            ...
                            vertexes: [{x: f, y: g, z: 0}, {x: e, y: g, z: 0}, {x: e, y: h, z: 0}, {x: f, y: h, z: 0}],
                            enabled: b.front.visible
                        }, {
                            fill: d.color(b.front.color).get(),
                            vertexes: [{x: q, y: m, z: p}, {x: k, y: m, z: p}, {x: k, y: n, z: p}, {x: q, y: n, z: p}],
                            enabled: b.front.visible
                        }]
                    })
                }
            ...
            function m() {
                this.styledMode && (this.renderer.definition({
                    ...
                    [{name: "darker", slope: .6}, {name: "brighter", slope: 1.4}].forEach(function (c) {
                        this.renderer.definition({
                            tagName: "filter",
                            id: "highcharts-" + c.name,
                            children: [{
                                tagName: "feComponentTransfer",
                                children: [{tagName: "feFuncR", type: "linear", slope: c.slope}, {
                                    tagName: "feFuncG",
                                    type: "linear",
                                    slope: c.slope
            ...
            function l() {
                var c = this.options;
                this.is3d() && (c.series || []).forEach(function (b) {
            ...
            function v() {
                ...
                if (this.chart3d && this.is3d()) {
                    c && (c.alpha = c.alpha % 360 + (0 <= c.alpha ? 0 : 360), c.beta = c.beta % 360 + (0 <= c.beta ? 0 : 360));
                    var b = this.inverted, a = this.clipBox, d = this.margin;
                    a[b ? "y" : "x"] = -(d[3] || 0);
                    a[b ? "x" : "y"] = -(d[0] || 0);
            ...
            var D = function () {
                ...
                c.prototype.get3dFrame = function () {
                    var c = this.chart, b = c.options.chart.options3d, a = b.frame, d = c.plotLeft,
                        e = c.plotLeft + c.plotWidth, f = c.plotTop, g = c.plotTop + c.plotHeight, k = b.depth,
                        n = function (a) {
                            a = h(a, c);
                            return .5 < a ? 1 : -.5 > a ? -1 : 0
                        }, m = n([{x: d, y: g, z: k}, {x: e, y: g, z: k}, {x: e, y: g, z: 0}, {x: d, y: g, z: 0}]),
                        l = n([{x: d, y: f, z: 0}, {x: e, y: f, z: 0}, {x: e, y: f, z: k}, {x: d, y: f, z: k}]),
                        v = n([{x: d, y: f, z: 0}, {x: d, y: f, z: k}, {x: d, y: g, z: k}, {x: d, y: g, z: 0}]),
                        r = n([{x: e, y: f, z: k}, {
                            x: e, y: f,
                            z: 0
                        }, {x: e, y: g, z: 0}, {x: e, y: g, z: k}]),
                        A = n([{x: d, y: g, z: 0}, {x: e, y: g, z: 0}, {x: e, y: f, z: 0}, {x: d, y: f, z: 0}]);
                    n = n([{x: d, y: f, z: k}, {x: e, y: f, z: k}, {x: e, y: g, z: k}, {x: d, y: g, z: k}]);
                    var u = !1, F = !1, w = !1, G = !1;
                    [].concat(c.xAxis, c.yAxis, c.zAxis).forEach(function (c) {
                        c && (c.horiz ? c.opposite ? F = !0 : u = !0 : c.opposite ? G = !0 : w = !0)
                    });
                    var C = function (c, a, b) {
                        for (var d = ["size", "color", "visible"], e = {}, f = 0; f < d.length; f++) for (var g = d[f], h = 0; h < c.length; h++) if ("object" === typeof c[h]) {
                            var k = c[h][g];
                        ...
                        return {size: q(e.size, 1), color: q(e.color, "none"), frontFacing: 0 < a, visible: c}
                    };
                    a = {
                        axes: {},
                    ...
                    "auto" === b.axisLabelPosition ? (r = function (c, a) {
                        ...
                        z: 0,
                        xDir: {x: 1, y: 0, z: 0}
                    }), r(a.left, a.back) && b.push({
                        y: (f + g) / 2,
                        x: d,
                        z: k,
                        xDir: {x: 0, y: 0, z: -1}
                    }), r(a.right, a.front) && b.push({
                        y: (f + g) / 2,
                        x: e,
                        z: 0,
                        xDir: {x: 0, y: 0, z: 1}
                    }), r(a.right, a.back) && b.push({
                        y: (f + g) / 2,
                        x: e,
                        z: k,
                        xDir: {x: -1, y: 0, z: 0}
                    }), m = [], r(a.bottom, a.front) && m.push({
                        x: (d + e) / 2,
                        y: g,
                        z: 0,
                        xDir: {x: 1, y: 0, z: 0}
                    }), r(a.bottom, a.back) && m.push({
                        x: (d + e) / 2,
                        y: g,
                        z: k,
                        xDir: {x: -1, y: 0, z: 0}
                    }), l = [], r(a.top, a.front) && l.push({
                        x: (d + e) / 2,
                        y: f,
                        z: 0,
                        xDir: {x: 1, y: 0, z: 0}
                    }), r(a.top, a.back) && l.push({
                        x: (d + e) /
                            2, y: f, z: k, xDir: {x: -1, y: 0, z: 0}
                    }), v = [], r(a.bottom, a.left) && v.push({
                        z: (0 + k) / 2,
                        y: g,
                        x: d,
                        xDir: {x: 0, y: 0, z: -1}
                    }), r(a.bottom, a.right) && v.push({
                        z: (0 + k) / 2,
                        y: g,
                        x: e,
                        xDir: {x: 0, y: 0, z: 1}
                    }), g = [], r(a.top, a.left) && g.push({
                        z: (0 + k) / 2,
                        y: f,
                        x: d,
                        xDir: {x: 0, y: 0, z: -1}
                    }), r(a.top, a.right) && g.push({
                        z: (0 + k) / 2,
                        y: f,
                        x: e,
                        xDir: {x: 0, y: 0, z: 1}
                        ...
                        for (var e = 0, f = p(a, c, !1), g = 1; g < f.length; g++) d * f[g][b] > d * f[e][b] ? e = g : d * f[g][b] === d * f[e][b] && f[g].z < f[e].z && (e = g);
                        return a[e]
                    },
                        a.axes = {
                        ...
                        z: {
                            top: {x: w ? e : d, y: f, xDir: w ? {x: 0, y: 0, z: 1} : {x: 0, y: 0, z: -1}},
                            bottom: {x: w ? e : d, y: g, xDir: w ? {x: 0, y: 0, z: 1} : {x: 0, y: 0, z: -1}}
                        }
                    };
                    return a
                };
                c.prototype.getScale = function (c) {
                    var a = this.chart, b = a.plotLeft, d = a.plotWidth + b, e = a.plotTop, f = a.plotHeight +
                        e, g = b + a.plotWidth / 2, h = e + a.plotHeight / 2, k = Number.MAX_VALUE,
                        n = -Number.MAX_VALUE, q = Number.MAX_VALUE, m = -Number.MAX_VALUE, l = 1;
                    var v = [{x: b, y: e, z: 0}, {x: b, y: e, z: c}];
                    ...
                    e > q && (l = 0 > q ? Math.min(l, (e + h) / (-q +
                        e + h)) : Math.min(l, 1 - (e + h) / (q + h) % 1));
            ...
            a.compose = function (h, q) {
                ...
                q.matrixSetter = function () {
                    if (1 > this.pos && (B(this.start) || B(this.end))) {
                        var c = this.start || [1, 0, 0, 1, 0, 0], a = this.end || [1, 0, 0, 1, 0, 0];
                        var b = [];
                        for (var d = 0; 6 > d; d++) b.push(this.pos * a[d] + (1 - this.pos) * c[d])
                    } else b = this.end;
    ...
    B(a, "Core/Series/Series3D.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Utilities.js"]], function (a, l, u) {
        ...
        a.Series.prototype.translate3dPoints = function () {
            ...
            a = d(l, a, !0);
            for (p = 0; p < this.data.length; p++) h = this.data[p], k = a[p], h.plotX = k.x, h.plotY = k.y, h.plotZ = k.z
        }
    });
    B(a, "Series/Column3DSeries.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"],
        ...
        function m(a, b) {
            var c = a.series, d = {}, k, e = 1;
            c.forEach(function (a) {
                k = h(a.options.stack, b ? 0 : c.length - 1 - a.index);
                d[k] ? d[k].series.push(a) : (d[k] = {series: [a], position: e}, e++)
            });
            d.totalStacks = e + 1;
            return d
        }
        ...
        function w(a) {
            ...
            this.chart.is3d && this.chart.is3d() && (b.stroke = this.options.edgeColor || b.fill, b["stroke-width"] = h(this.options.edgeWidth, 1));
            return b
        }
        ...
        var h = d.pick;
        d = d.wrap;
        var r = a.Series, b = a.seriesTypes, B = a.svg;
        ...
        b.column.prototype.translate3dShapes = function () {
            var a = this, b = a.chart, c = a.options, d = c.depth,
                h = (c.stacking ? c.stack || 0 : a.index) * (d + (c.groupZPadding || 1)),
                e = a.borderWidth % 2 ? .5 : 0, k;
        ...
        d(b.column.prototype, "animate", function (a) {
            if (this.chart.is3d()) {
                var b = arguments[1], c = this.yAxis, d = this, h = this.yAxis.reversed;
                B && (b ? d.data.forEach(function (a) {
                    null !== a.y && (a.height = a.shapeArgs.height, a.shapey = a.shapeArgs.y, a.shapeArgs.height = 1, h || (a.shapeArgs.y = a.stackY ? a.plotY + c.translate(a.stackY) : a.plotY + (a.negative ? -a.height : a.height)))
        ...
        d(b.column.prototype, "setVisible", function (a, b) {
            ...
            c.chart.is3d() && c.data.forEach(function (a) {
                d = (a.visible = a.options.visible = b = "undefined" === typeof b ? !h(c.visible, a.visible) : b) ? "visible" : "hidden";
        ...
        l(r, "afterInit", function () {
            if (this.chart.is3d() &&
                ...
                var a = this.options, b = a.grouping, c = a.stacking, d = h(this.yAxis.options.reversedStacks, !0),
                    k = 0;
        ...
        d(b.column.prototype.pointClass.prototype, "hasNewShapeType",
            G);
        b.columnrange && (d(b.columnrange.prototype, "pointAttribs", w), d(b.columnrange.prototype, "setState", k), d(b.columnrange.prototype.pointClass.prototype, "hasNewShapeType", G), b.columnrange.prototype.plotGroup = b.column.prototype.plotGroup, b.columnrange.prototype.setVisible = b.column.prototype.setVisible);
        d(r.prototype, "alignDataLabel", function (a, b, c, d, k) {
            ...
            if (e.is3d() && this.is("column")) {
                ...
                e.inverted && (m && (k.width = 0, l.x += b.shapeArgs.height / 2), 90 <= n.alpha && 270 >= n.alpha && (l.y += b.shapeArgs.width));
                l = p([l], e, !0, !1)[0];
                k.x = l.x - q;
        ...
        d(u.prototype, "getStackBox", function (a, d, c, h, k, e, l, m) {
            ...
            if (d.is3d() && c.base) {
                var q = +c.base.split(",")[0], g = d.series[q];
                q = d.options.chart.options3d;
                g && g instanceof b.column && (g = {
                    x: n.x + (d.inverted ?
    ...
    B(a, "Series/Pie3DSeries.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, l) {
        var u = l.pick;
        l = l.wrap;
        var d = a.deg2rad, m = a.seriesTypes, w = a.svg;
        l(m.pie.prototype, "translate", function (a) {
            a.apply(this, [].slice.call(arguments, 1));
            if (this.chart.is3d()) {
                var k = this, l = k.options, h = l.depth || 0, m = k.chart.options.chart.options3d, b = m.alpha,
                    u = m.beta, n = l.stacking ?
                    (l.stack || 0) * h : k._i * h;
                n += h / 2;
                !1 !== l.grouping && (n = 0);
                k.data.forEach(function (a) {
                    ...
                    c = (c.end + c.start) / 2;
                    a.slicedTranslation = {
                        translateX: Math.round(Math.cos(c) * l.slicedOffset * Math.cos(b * d)),
                        translateY: Math.round(Math.sin(c) * l.slicedOffset * Math.cos(b * d))
                    }
                })
            }
        });
        ...
        l(m.pie.prototype, "pointAttribs",
            function (a, d, l) {
                a = a.call(this, d, l);
                l = this.options;
                this.chart.is3d() && !this.chart.styledMode && (a.stroke = l.edgeColor || d.color || this.color, a["stroke-width"] = u(l.edgeWidth, 1));
                return a
            });
        l(m.pie.prototype, "drawDataLabels", function (a) {
            if (this.chart.is3d()) {
                ...
                this.data.forEach(function (a) {
                    var h = a.shapeArgs, l = h.r, b = (h.start + h.end) / 2;
                    a = a.labelPosition;
                    var m = a.connectorPosition, n = -l * (1 - Math.cos((h.alpha || k.alpha) * d)) * Math.sin(b),
        ...
        l(m.pie.prototype, "animate", function (a) {
            if (this.chart.is3d()) {
                var d = arguments[1], k = this.options.animation, h = this.center, l = this.group, b = this.markerGroup;
                w && (!0 === k && (k = {}), d ? (l.oldtranslateX = u(l.oldtranslateX, l.translateX), l.oldtranslateY = u(l.oldtranslateY,
                    l.translateY), d = {
                    translateX: h[0],
                    translateY: h[1],
                    scaleX: .001,
                    scaleY: .001
                }, l.attr(d), b && (b.attrSetters = l.attrSetters, b.attr(d))) : (d = {
                    translateX: l.oldtranslateX,
                    translateY: l.oldtranslateY,
                    scaleX: 1,
                    scaleY: 1
                }, l.animate(d, k), b && b.animate(d, k)))
            } else a.apply(this, [].slice.call(arguments, 1))
        })
    });
    B(a, "Series/Scatter3DSeries.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, l, u, d) {
        ...
        l = d.seriesType;
        var w = a.seriesTypes;
        l("scatter3d", "scatter", {tooltip: {pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>"}}, {
    ...
    B(a, "Core/Renderer/VML/VMLRenderer3D.js", [a["Core/Axis/Axis.js"], a["Core/Globals.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"], a["Core/Axis/VMLAxis3D.js"]], function (a, l, u, d, m) {
        d = d.setOptions;
        var w = l.VMLRenderer;
        w && (d({animate: !1}), w.prototype.face3d = u.prototype.face3d, w.prototype.polyhedron = u.prototype.polyhedron, w.prototype.elements3d = u.prototype.elements3d, w.prototype.element3d =
            u.prototype.element3d, w.prototype.cuboid = u.prototype.cuboid, w.prototype.cuboidPath = u.prototype.cuboidPath, w.prototype.toLinePath = u.prototype.toLinePath, w.prototype.toLineSegments = u.prototype.toLineSegments, w.prototype.arc3d = function (a) {
            a = u.prototype.arc3d.call(this, a);
            a.css({zIndex: a.zIndex});
            return a
        }, l.VMLRenderer.prototype.arc3dPath = u.prototype.arc3dPath, m.compose(a))
    });
